package pl.kostrzynski.intentservice.service;
...
import pl.kostrzynski.intentservice.activities.MainActivity;


public class ChuckNorrisIntentService extends IntentService {

    private static final String TAG="pl.kostrzynski.intentservice.service";
